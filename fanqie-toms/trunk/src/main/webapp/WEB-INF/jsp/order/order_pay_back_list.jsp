...
<%--同意退款--%>
<!-- Modal -->
<div class="modal fade" id="payBackSure" tabindex="-1" role="dialog" aria-labelledby="myRefuesOrder"
     aria-hidden="false">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <br/>
                您选择“同意退款”操作,系统将在客栈PMS中取消该订单
            </div>
            <input type="hidden" class="pay-back-sure-url"/>

            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-success btn-pay-back-sure">确认</button>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="refusePayBack" tabindex="-1" role="dialog" aria-labelledby="myConfirmNoOrder"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <input type="hidden" class="refuse-pay-back-url"/>

            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-success btn-refuse-pay-back-sure">确认</button>
            </div>
        </div>
    </div>
</div>
