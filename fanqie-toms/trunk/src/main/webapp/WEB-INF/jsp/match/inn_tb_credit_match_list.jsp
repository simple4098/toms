    ...
    <table class="table table-bordered">
        ...
        <c:forEach items="${list}" var="o">
            <tr>
                ...
                <td>
                    <a class="btn btn-primary btn-sm" sj="${o.sj==0?'1':'0'}" otaInfoId="${otaInfoId}" innId="${o.innId}" />
                    <c:if test="${o.sj==0}">上架</c:if><c:if test="${o.sj==1}">下架</c:if>
                    </a>
                </td>
            </tr>
        </c:forEach>
