...
<div class="container">
  <ul class="nav-bar clearfix" style=" height: 63px;">
    <c:forEach items="${infoList}" var="o">
      <li <c:if test="${o.otaType.name()=='FC'}">class="background"</c:if>><a  href="<c:url value="/innMatch/match?otaInfoId=${o.otaInfoId}"/>">${o.otaInfo}</a></li>
    </c:forEach>
  </ul>
    ...
    <div class="widget-body">
      <div class="widget-main ">
        <form class="form-horizontal" role="form">
          ...
          <input name="otaType" id="otaTypeId" type="hidden" value="FC">
          <div class="row">
            <div class="col-xs-4">
