...
$("#sub-id").on("click",function(){
    ...
    $.ajax({
        ...
        type:'post',
        dataType:'json',
        data:{"appKey":appKey,"appSecret":appSecret,"sessionKey":sessionKey,"otaInfoId":otaInfoId,"otaType":otaType,"usedPriceModel":usedPriceModel},
