...
public class TomsUtil {
     ...
     * @return
     */
    public static String getMyselfChannelCode(String companyCode, String channelName) {
        //得到名称全拼
        String spell = JStringUtil.getSpell(channelName, false);
        //得到一个四位随机数
        int nextInt = new Random().nextInt(9999);
        return companyCode + nextInt + "_" + spell.toUpperCase();
    }
}
